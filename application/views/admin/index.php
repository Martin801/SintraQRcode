    ...
    <div class="container">
        ...
        <form action="<?php echo base_url('AdminLogin/login'); ?>" method="POST">
            ...
            <div class="input-block">
                ...
                <input required="required" type="text" placeholder="Username" name="admin_username" id="admin_username">
            </div>
            <div class="input-block">
                <i class="fa fa-lock"></i>
                <input required="required" type="password" placeholder="Password" name="admin_pwd" id="admin_pwd">
            </div>
            <button type="submit" class="code-btn">Admin Login</button>
        </form>
    </div>
</section>
</main>
